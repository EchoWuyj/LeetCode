...
//        node2.right = node7;
        ...
        System.out.println(BinaryTree.preOrder(root_23));  // [23, 34, 99, 77, 90, 21, 45, 60]
        System.out.println("===============");
        System.out.println(BinaryTree.inOrder(root_23)); // [77, 99, 90, 34, 23, 45, 21, 60]
        System.out.println("===============");
        System.out.println(BinaryTree.postOrder(root_23)); // [77, 90, 99, 34, 45, 60, 21, 23]
        System.out.println("===============");
        System.out.println(BinaryTree.levelOrder(root_23)); // [23, 34, 21, 99, 45, 60, 77, 90]
        System.out.println("===============");
        System.out.println(BinaryTree.levelOrder_2(root_23)); // [[23], [34, 21], [99, 45, 60], [77, 90]]
    }
}
