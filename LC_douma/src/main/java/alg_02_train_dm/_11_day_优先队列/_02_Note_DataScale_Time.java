 ...
 * @Version 1.0
 */
public class _02_Note_DataScale_Time {
    ...
    /*
        ...
        2.当 n = 10^5 (100,000) 时，log n 表示以 2 为底的对数，即 log2(10^5)，即：log2(10^5) ≈ 16.6094 < 20

        如果一个问题，数据规模是 10^4，O(nsqrt(n)) 的算法就没问题，此时 nsqrt(n) = 10^6；
        sqrt 平方根

        数据规模是 10^3，O(n^2) 的算法就没问题，此时 n^2 = 10^6；
        数据规模是 10^2，O(n^3) 的算法就没问题，此时 n^3 = 10^6；
        数据规模是 20,，此时，O(2^n) 的算法就没问题，此时，2^n 大概是 10^6。
        2^20 => 1048576
