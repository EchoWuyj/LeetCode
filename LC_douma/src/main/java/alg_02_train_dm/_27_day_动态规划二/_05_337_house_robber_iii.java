...
public class _05_337_house_robber_iii {
    ...
    public int[] dfs(TreeNode node) {
        ...
        // 选择不偷当前的节点的话，那么有四种情况，在其中选择选择最大值
    ...
    public int rob1(TreeNode root) {
        ...
        while (!queue.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                // 在 Java 中，三元运算符的返回值是一个表达式，而不是一个语句。
                // 条件表达式 ? 表达式 1: 表达式 2;
