 ...
 * @Version 1.0
 */
public class _08_23_merge_k_sorted_lists2_推荐 {
    ...
    public ListNode mergeKLists(ListNode[] lists) {
        // KeyPoint 一个元素，lists 从 0 开始，不是从 1 开始
    ...
    private ListNode merge(ListNode[] lists, int left, int right) {
        ...
        // KeyPoint merge 形参是区间 [left,right]，调用分治 merge，最后才去 mergeTwoLists
    ...
    public ListNode mergeTwoLists(ListNode l1, ListNode l2) {
        ...
        // KeyPoint 一定是 cur.next 指针，而不是单纯的 cur
