...
public class _12_476_number_complement {
    ...
    public int findComplement(int num) {
        ...
        // 想要结果 0000 0000 0000 0000 0000 0000 0000 0|010

        // 理论依据：对二进制的高 16 位进行取反 => 先对低 16 位取反，再对整个二进制取反 => ~(n ^ 0xFFFF)

        // num = 5 0000 0000 0000 0000 0000 0000 0000 0101
        //         1111 1111 1111 1111 1111 1111 1111 1111 => 不断左移，直到第一个前导零位，得到 mask
        //  mask   1111 1111 1111 1111 1111 1111 1111 1000 => num & mask = 0 停止左移
