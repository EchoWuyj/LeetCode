...
public class _11_547_number_of_provinces {
    /*
       ...
       如果城市 a 与城市 b 直接 相连，且城市 b 与城市 c 直接 相连，
       那么城市 a 与城市 c 间接 相连。
    ...
    */
    ...
    public int findCircleNum(int[][] isConnected) {
        ...
        // 使用并查集求解：抽象出并查集有多少个顶点，每个顶点是一个独立集合
        // 本题：有多少个城市，就有多少个顶点，n x n 矩阵，顶点个数为 n
        ...
        for (int i = 0; i < rows; i++) {
            ...
            // 只要遍历矩阵的右上半部分即可，不含有主对角线
            // 因为 0 1 连通 和 1 0 连通是重复的
