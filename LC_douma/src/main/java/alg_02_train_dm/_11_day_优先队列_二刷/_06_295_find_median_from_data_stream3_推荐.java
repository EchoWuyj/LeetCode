 ...
 * @Version 1.0
 */
public class _06_295_find_median_from_data_stream3_推荐 {
    ...
    class MedianFinder {
        ...
        // 2.若元素的个数是奇数，将多出的元素放在前一半，则大顶堆中的元素个数比小顶堆中元素个数多 1
        ...
        public void addNum(int num) {
            ...
            // 1.大顶堆元素多了，往小顶堆中调整
            // maxHeap 最差情况：maxHeap 个数 大于 minHeap 只能是 1 个
            if (maxHeap.size() > minHeap.size() + 1) {
                minHeap.add(maxHeap.remove());
            }

            // 2.小顶堆元素多了，往大顶堆中调整
            // maxHeap 最差情况：maxHeap个数 和 minHeap 相等
