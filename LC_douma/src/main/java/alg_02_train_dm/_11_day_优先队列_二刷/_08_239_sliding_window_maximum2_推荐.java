 ...
 * @Version 1.0
 */
public class _08_239_sliding_window_maximum2_推荐 {
    ...
    public int[] maxSlidingWindow2(int[] nums, int k) {
        ...
        // 注意：堆中不仅仅存储数组元素，还需要存储数组元素对应的索引，从而方便判断该元素是否还在窗口中
        //       将两个信息整体封装成数组形式存到堆中
        ...
        for (int i = k; i < n; i++) { // O(n-k)
            ...
            // 如：若 i = 4，k = 3 => 则窗口范围：[2,3,4]
            // => maxHeap.peek()[1] <= i-k = 4-3 = 1，将其从窗口弹出
            ...
            // KeyPoint 区别
            // 数字 1 和 字母 i，两者不要相混淆 => 经常容易犯错，务必要小心！
