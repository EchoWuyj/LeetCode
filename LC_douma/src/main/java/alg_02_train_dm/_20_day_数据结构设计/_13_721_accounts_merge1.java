 ...
 * @Version 1.0
 */
public class _13_721_accounts_merge1 {
     /* 
        721. 账户合并
       ...
       */
        ...
        for (List<String> account : accounts) {
            ...
            for (int i = 1; i < size; i++) {
                ...
                // KeyPoint 通过 Map 的 Key 去重，同时 count 计数作为 id，保证 id 不重复
        ...
        */
        ...
        for (String email : emailToIndex.keySet()) {
            ...
            // KeyPoint 找到根节点
            // 注意：只要是同一个集合中，find 最后都是相同的 root
            // 通过 root 作为一个集合的标识，将相同的集合元素存在一起
            int indexRoot = uf.find(index);
            // 以每个 root 节点为 key，创建一个关于邮箱集合 (value)，整体作为 Map 映射
