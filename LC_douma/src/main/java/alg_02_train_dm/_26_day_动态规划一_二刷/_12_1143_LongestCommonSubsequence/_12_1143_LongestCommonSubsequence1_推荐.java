 ...
 * @Version 1.0
 */
public class _12_1143_LongestCommonSubsequence1_推荐 {
    ...
    public int longestCommonSubsequence(String text1, String text2) {
        ...
        // 第一行为 0 => 前 0 字符 => 空串 "" => 没有公共子序列
        // dp[0][j] = 0;

        // 第一列为 0 => 前 0 字符 => 空串 "" => 没有公共子序列
        // dp[i][0] = 0;
        ...
        for (int i = 1; i <= m; i++) {
            for (int j = 1; j <= n; j++) {
                ...
                if (text1.charAt(i - 1) == text2.charAt(j - 1)) {
                    ...
                    // 注意点 1：
                    // 一般区间 [i,j] 范围 dp，状态转移 dp[i][j] 与 dp[i+1][j-1]
        ...
        // dp[m][n]：text1 前 m 个字符和 text2 前 n 个字符的最长公共子序列长度
        return dp[m][n];
