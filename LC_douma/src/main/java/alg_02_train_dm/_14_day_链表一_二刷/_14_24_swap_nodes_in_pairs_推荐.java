 ...
 * @Version 1.0
 */
public class _14_24_swap_nodes_in_pairs_推荐 {
    ...
    public ListNode swapPairs(ListNode head) {
        ...
        // 因为 first 和 second 是一定存在的，故可以直接赋值
        ...
        // 若 second == null，则 first 和 second 构不成两个节点
        // 即只有 first 一个节点，则不用交换，则不用执行 while 中的交换操作
        while (second != null) {
            ...
            prev = first;
            first = next;
            // first 移动 next 位置，且 first 为 null，则说明，恰好是 2 的倍数节点，提前结束 while 循环
