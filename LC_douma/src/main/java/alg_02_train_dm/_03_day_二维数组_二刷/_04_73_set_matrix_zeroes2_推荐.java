 ...
 * @Version 1.0
 */
public class _04_73_set_matrix_zeroes2_推荐 {
    ...
    public void setZeroes2(int[][] matrix) {
        ...
        // 操作逻辑
        // 1.先标记第一行，第一列是否包含 0
        // 2.从第二行，第二列开始逐行 标记 0，坐标索引从 (1,1) 开始
        // 3.从第二行，第二列开始逐行 设置 0，坐标索引从 (1,1) 开始
        // 4.根据标记值，再去设置第一行，第一列是否为 0
        ...
        // 4.根据标记值 flagRow 和 flagCol，设置第一行，第一列是否为 0
        if (flagRow) {
            for (int i = 0; i < n; i++) {
                matrix[0][i] = 0;
            }
