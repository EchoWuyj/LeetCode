 ...
 * @Version 1.0
 */
public class _04_32_longest_valid_parentheses4 {
    ...
    public int longestValidParentheses(String s) {
        ...
        // 若遇到这种情况："( ( ( ) )"
        // for 循环中，left 先增，right 后增，导致遍历过程中没有出现 left == right
        // 直到 left = 3，right = 2，left > right，则找不到最长有效括号，但实际上是存在最长有效括号为 4
        // 故代码存在 bug，还需要再从右往左遍历
