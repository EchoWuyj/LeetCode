...
public class Problem_0102_Note_LinkedList {
      /*
         ...
         -----------------------------------------------------------------
         void addFirst(Object o) ⇋ offerFirst ⇋ push (Deque) 将指定元素插入集合的开头
         void addLast(Object o) ⇋ offerLast ⇋ offer ⇋ add 将指定元素添加到集合的结尾
         -----------------------------------------------------------------
         Object getFirst() 返回集合的第一个元素  => 遇到 null，抛出异常 => 记忆： get 异常
         Object getLast() 返回集合的最后一个元素

         Object peekFirst() ⇋ peek 获取集合的第一个元素  => 遇到 null，返回 null
         Object peekLast() 获取集合的最后一个元素
         --------------------------------------------------------------------
         Object removeFirst() ⇋ pop 移除并返回集合的第一个元素 => 遇到 null，抛出异常
         Object removeLast() 移除并返回集合的最后一个元素

         Object pollFirst() ⇋ poll 移除并返回集合的第一个元素 => 遇到 null，返回 null
         Object pollLast() 移除并返回集合的最后一个元素

         KeyPoint 方法对应关系
         1.add，remove，get => 记忆：AR
         2.offer，poll，peek => 记忆：OP
